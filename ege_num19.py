def game(k1, k2, pos):  # Функция игры
    # дальше три проверки
    if k1 + k2 >= 79 and pos == 2:  # Если сейчас нужный нам Ход и уловия Выигрыша выполены, то возврашаем True
        return True
    if k1 + k2 < 79 and pos == 2:  # Если сейчас нужный нам Ход, но уловия Выигрыша не выполены, то возврашаем False
        return False
    if k1 + k2 >= 79 and pos != 2:  # Если уловия Выигрыша выполены, но не нужный нам Ход, то возврашаем False
        return False
